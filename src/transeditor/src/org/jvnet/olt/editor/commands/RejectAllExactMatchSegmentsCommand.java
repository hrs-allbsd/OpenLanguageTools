 ...
 * @author  jc73554
 */
public class RejectAllExactMatchSegmentsCommand implements java.awt.event.ActionListener {
    private MainFrame controller;

    /** Creates a new instance of RejectReviewedFileCommand */
    public RejectAllExactMatchSegmentsCommand(MainFrame controller) {
        this.controller = controller;
    }

    public void actionPerformed(java.awt.event.ActionEvent e) {
        controller.setExactMatchSegmentReviewStatus(false);
    }
}
