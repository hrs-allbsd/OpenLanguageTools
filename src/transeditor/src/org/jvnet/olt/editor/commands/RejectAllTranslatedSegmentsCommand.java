 ...
 * @author  jc73554
 */
public class RejectAllTranslatedSegmentsCommand implements java.awt.event.ActionListener {
    private MainFrame controller;

    /** Creates a new instance of RejectReviewedFileCommand */
    public RejectAllTranslatedSegmentsCommand(MainFrame controller) {
        this.controller = controller;
    }

    public void actionPerformed(java.awt.event.ActionEvent e) {
        controller.setReviewStatusOnAllSegs(false);
    }
}
