 ...
 * @author  jc73554
 */
public class ApproveSegmentCommand implements java.awt.event.ActionListener {
    private MainFrame controller;

    /** Creates a new instance of RejectReviewedFileCommand */
    public ApproveSegmentCommand(MainFrame controller) {
        this.controller = controller;
    }

    public void actionPerformed(java.awt.event.ActionEvent e) {
        controller.setSegmentReviewStatus(true);
    }
}
