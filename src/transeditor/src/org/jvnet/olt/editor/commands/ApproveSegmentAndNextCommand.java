 ...
 * @author  jc73554
 */
public class ApproveSegmentAndNextCommand implements java.awt.event.ActionListener {
    private MainFrame controller;

    /** Creates a new instance of RejectReviewedFileCommand */
    public ApproveSegmentAndNextCommand(MainFrame controller) {
        this.controller = controller;
    }

    public void actionPerformed(java.awt.event.ActionEvent e) {
        controller.setReviewStatusAndGotoNext(true);
    }
}
