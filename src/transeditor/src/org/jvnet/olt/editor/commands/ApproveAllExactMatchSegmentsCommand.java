 ...
 * @author  jc73554
 */
public class ApproveAllExactMatchSegmentsCommand implements java.awt.event.ActionListener {
    private MainFrame controller;

    /** Creates a new instance of RejectReviewedFileCommand */
    public ApproveAllExactMatchSegmentsCommand(MainFrame controller) {
        this.controller = controller;
    }

    public void actionPerformed(java.awt.event.ActionEvent e) {
        controller.setExactMatchSegmentReviewStatus(true);
    }
}
