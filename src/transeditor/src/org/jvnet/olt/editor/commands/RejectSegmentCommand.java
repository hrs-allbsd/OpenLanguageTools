 ...
 * @author  jc73554
 */
public class RejectSegmentCommand implements java.awt.event.ActionListener {
    private MainFrame controller;

    /** Creates a new instance of RejectReviewedFileCommand */
    public RejectSegmentCommand(MainFrame controller) {
        this.controller = controller;
    }

    public void actionPerformed(java.awt.event.ActionEvent e) {
        controller.setSegmentReviewStatus(false);
    }
}
