...
public class ZippedXliffFileFilter extends javax.swing.filechooser.FileFilter {
    ...
    public boolean accept(java.io.File file) {
        ...
        return (file.exists() && file.canRead() && fileName.endsWith("xlz"));
    }
    ...
    public String getDescription() {
        return "Zipped XLIFF bundles (*.xlz)";
    }
}
