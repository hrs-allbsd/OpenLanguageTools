...
public class FontQueryDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        java.util.Vector<String> families = new java.util.Vector<String>();
        families.add("Dialog"); // old and default value
        families.addAll(java.util.Arrays.asList(java.awt.GraphicsEnvironment.getLocalGraphicsEnvironment().getAvailableFontFamilyNames()));
        comboFamily.setModel(new javax.swing.DefaultComboBoxModel(families));
        comboFamily.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                comboFamilyActionPerformed(evt);
            }
        });
        mainPanel.add(comboFamily, java.awt.BorderLayout.NORTH);
        ...
        setBounds((screenSize.width-308)/2, (screenSize.height-280)/2, 308, 280);
    ...
    private void radioLargeTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radioLargeTextActionPerformed
        sampleLabel.setFont(new Font(getFontFamily(), Font.PLAIN, 24));
    ...
    private void radioMediumTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radioMediumTextActionPerformed
        sampleLabel.setFont(new Font(getFontFamily(), Font.PLAIN, 18));
    ...
    private void radioSmallTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radioSmallTextActionPerformed
        sampleLabel.setFont(new Font(getFontFamily(), Font.PLAIN, 12));
    ...
    private void comboFamilyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboFamilyActionPerformed
        sampleLabel.setFont(new Font(getFontFamily(), Font.PLAIN, sampleLabel.getFont().getSize()));
    }//GEN-LAST:event_comboFamilyActionPerformed
    ...
    public Font getFontSizeSelection() {
        ...
        switch(newFontSizeSelection) {
            ...
            case FontQueryDialog.MEDIUMFONT:
                return new Font(getFontFamily(), Font.PLAIN, 18);
            case FontQueryDialog.LARGEFONT:
                return new Font(getFontFamily(), Font.PLAIN, 24);
            default:
                return new Font(getFontFamily(), Font.PLAIN, 12);    // If in doubt return the small font.             
        }
    }
    ...
    public void setFontSelectionOption(int selection) {
        ...
        switch(selection) {
            case SMALLFONT:
                ...
                sampleLabel.setFont(new Font(getFontFamily(), Font.BOLD, 12));
                break;
            case MEDIUMFONT:
                buttonModel = radioMediumText.getModel();
                sampleLabel.setFont(new Font(getFontFamily(), Font.BOLD, 18));
                break;
            case LARGEFONT:
                buttonModel = radioLargeText.getModel();
                sampleLabel.setFont(new Font(getFontFamily(), Font.BOLD, 24));
                break;
        }
    ...
    private String getFontFamily() {
        return comboFamily.getSelectedItem().toString();
    }
