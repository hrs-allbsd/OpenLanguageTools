 ...
 * A Language within OLTE represents an xml language and is identified by<br>
 *  an ISO language code (ISO 639-1 or 639-2 if no 639-1 code is available)<br>
 *  an optional ISO Country code ((ISO 3166)<br>
 * Internally it is handled as a Locale. See Javadoc java.util.Locale for
