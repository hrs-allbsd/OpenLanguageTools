...
implements Node, NonConformantSgmlTagParserTreeConstants
{
  ...
  /** Accept the visitor. **/
  public Object jjtAccept(NonConformantSgmlTagParserVisitor visitor, Object data)  {
...
/** Accept the visitor. **/
  ...
  public Object childrenAccept(NonConformantSgmlTagParserVisitor visitor, Object data) {
    if (children != null) {
  ...
  public String toString() { return NonConformantSgmlTagParserTreeConstants.jjtNodeName[id]; }
