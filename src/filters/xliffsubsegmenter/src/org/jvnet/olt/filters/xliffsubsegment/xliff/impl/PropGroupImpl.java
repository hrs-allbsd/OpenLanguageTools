...
public class PropGroupImpl implements org.jvnet.olt.filters.xliffsubsegment.xliff.PropGroup, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, org.jvnet.olt.filters.xliffsubsegment.xliff.impl.runtime.UnmarshallableObject, org.jvnet.olt.filters.xliffsubsegment.xliff.impl.runtime.XMLSerializable, org.jvnet.olt.filters.xliffsubsegment.xliff.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Prop;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (org.jvnet.olt.filters.xliffsubsegment.xliff.PropGroup.class);
    }
    ...
    protected com.sun.xml.bind.util.ListImpl _getProp() {
        if (_Prop == null) {
            _Prop = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Prop;
    }

    public java.util.List getProp() {
        return _getProp();
    }
    ...
    public org.jvnet.olt.filters.xliffsubsegment.xliff.impl.runtime.UnmarshallingEventHandler createUnmarshaller(org.jvnet.olt.filters.xliffsubsegment.xliff.impl.runtime.UnmarshallingContext context) {
        return new org.jvnet.olt.filters.xliffsubsegment.xliff.impl.PropGroupImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Prop == null)? 0 :_Prop.size());
        context.startElement("", "prop-group");
        int idx_0 = idx1;
        while (idx_0 != len1) {
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Prop.get(idx_0 ++)), "Prop");
        }
        ...
        while (idx_2 != len1) {
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Prop.get(idx_2 ++)), "Prop");
        }
        context.endAttributes();
        while (idx1 != len1) {
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Prop.get(idx1 ++)), "Prop");
        }
        context.endElement();
    }
...
+"xr\u0000\u001dcom.sun.msv.grammar.NameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xpt\u0000\u0004nameq\u0000~\u0000&sr"
+"\u00000com.sun.msv.grammar.Expression$EpsilonExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000"
+"\u0000xq\u0000~\u0000\u0004sq\u0000~\u0000\u000e\u0001q\u0000~\u0000,sr\u0000 com.sun.msv.grammar.OneOrMoreExp\u0000\u0000\u0000\u0000\u0000"
+"\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000\u001ccom.sun.msv.grammar.UnaryExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\u0003expq\u0000~\u0000\u0003"
+"xq\u0000~\u0000\u0004ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\nppsq\u0000~\u0000.q\u0000~\u0000\u000fpsq\u0000~\u0000\fq\u0000~\u0000\u000fpsr\u00002com.sun"
+".msv.grammar.Expression$AnyStringExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0004"
+"q\u0000~\u0000-q\u0000~\u00006sr\u0000 com.sun.msv.grammar.AnyNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000"
+"~\u0000(q\u0000~\u0000,sq\u0000~\u0000\'t\u0000-org.jvnet.olt.filters.xliffsubsegment.xliff.Pr"
+"opt\u0000+http://java.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\'t\u0000\npro"
+"p-groupq\u0000~\u0000&sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000"
...
+"/ExpressionPool;xp\u0000\u0000\u0000\u0005\u0001pq\u0000~\u0000\tq\u0000~\u00002q\u0000~\u0000\u000bq\u0000~\u00000q\u0000~\u00003x"));
        }
        ...
        extends org.jvnet.olt.filters.xliffsubsegment.xliff.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return org.jvnet.olt.filters.xliffsubsegment.xliff.impl.PropGroupImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        ...
                        continue outer;
                    case  5 :
                        if (("prop" == ___local)&&("" == ___uri)) {
                            _getProp().add(((org.jvnet.olt.filters.xliffsubsegment.xliff.impl.PropImpl) spawnChildFromEnterElement((org.jvnet.olt.filters.xliffsubsegment.xliff.impl.PropImpl.class), 5, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  0 :
