...
public class CountImpl implements org.jvnet.olt.filters.xliffsubsegment.xliff.Count, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, org.jvnet.olt.filters.xliffsubsegment.xliff.impl.runtime.UnmarshallableObject, org.jvnet.olt.filters.xliffsubsegment.xliff.impl.runtime.XMLSerializable, org.jvnet.olt.filters.xliffsubsegment.xliff.impl.runtime.ValidatableObject
{

    protected java.lang.String _CountType;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (org.jvnet.olt.filters.xliffsubsegment.xliff.Count.class);
    }
    ...
    public void setCountType(java.lang.String value) {
        _CountType = value;
    }
    ...
    public org.jvnet.olt.filters.xliffsubsegment.xliff.impl.runtime.UnmarshallingEventHandler createUnmarshaller(org.jvnet.olt.filters.xliffsubsegment.xliff.impl.runtime.UnmarshallingContext context) {
        return new org.jvnet.olt.filters.xliffsubsegment.xliff.impl.CountImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        if (_CountType!= null) {
            context.startAttribute("", "count-type");
            try {
                context.text(((java.lang.String) _CountType), "CountType");
            } catch (java.lang.Exception e) {
                org.jvnet.olt.filters.xliffsubsegment.xliff.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endAttribute();
...
+"URIq\u0000~\u0000\u001axr\u0000\u001dcom.sun.msv.grammar.NameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xpt\u0000\u0004uni"
+"tq\u0000~\u0000\'sr\u00000com.sun.msv.grammar.Expression$EpsilonExpression\u0000\u0000"
+"\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0004sq\u0000~\u0000\u000f\u0001q\u0000~\u0000-sq\u0000~\u0000\u000bppsq\u0000~\u0000\rq\u0000~\u0000\u0010pq\u0000~\u0000\u0014sq\u0000~\u0000(t\u0000"
+"\ncount-typeq\u0000~\u0000\'q\u0000~\u0000-sq\u0000~\u0000\u0011q\u0000~\u0000\u0010psq\u0000~\u0000\u0016q\u0000~\u0000\u001dt\u0000\u0006stringsr\u00005com"
+".sun.msv.datatype.xsd.WhiteSpaceProcessor$Preserve\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000"
+"\u0000xq\u0000~\u0000 \u0001q\u0000~\u0000#sq\u0000~\u0000$q\u0000~\u00005q\u0000~\u0000\u001dsq\u0000~\u0000(t\u0000\u0005countq\u0000~\u0000\'sr\u0000\"com.sun."
...
+"q\u0000~\u0000\tq\u0000~\u0000/q\u0000~\u0000\nq\u0000~\u0000\fx"));
        ...
        extends org.jvnet.olt.filters.xliffsubsegment.xliff.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return org.jvnet.olt.filters.xliffsubsegment.xliff.impl.CountImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  4 :
                        attIdx = context.getAttribute("", "count-type");
                        if (attIdx >= 0) {
                    ...
                    case  0 :
                        ...
                        break;
                    case  1 :
                        attIdx = context.getAttribute("", "unit");
                        if (attIdx >= 0) {
                            final java.lang.String v = context.eatAttribute(attIdx);
                            eatText2(v);
                            state = 4;
        ...
        {
            try {
                _CountType = com.sun.xml.bind.WhiteSpaceProcessor.replace(value);
            } catch (java.lang.Exception e) {
        ...
        {
            try {
                _Unit = com.sun.xml.bind.WhiteSpaceProcessor.replace(value);
            } catch (java.lang.Exception e) {
                handleParseConversionException(e);
            }
        }
