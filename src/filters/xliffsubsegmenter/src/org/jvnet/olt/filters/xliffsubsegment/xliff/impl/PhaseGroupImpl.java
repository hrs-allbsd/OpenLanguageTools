...
public class PhaseGroupImpl implements org.jvnet.olt.filters.xliffsubsegment.xliff.PhaseGroup, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, org.jvnet.olt.filters.xliffsubsegment.xliff.impl.runtime.UnmarshallableObject, org.jvnet.olt.filters.xliffsubsegment.xliff.impl.runtime.XMLSerializable, org.jvnet.olt.filters.xliffsubsegment.xliff.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Phase;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (org.jvnet.olt.filters.xliffsubsegment.xliff.PhaseGroup.class);
    }
    ...
    protected com.sun.xml.bind.util.ListImpl _getPhase() {
        if (_Phase == null) {
            _Phase = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Phase;
    }

    public java.util.List getPhase() {
        return _getPhase();
    }
    ...
    public org.jvnet.olt.filters.xliffsubsegment.xliff.impl.runtime.UnmarshallingEventHandler createUnmarshaller(org.jvnet.olt.filters.xliffsubsegment.xliff.impl.runtime.UnmarshallingContext context) {
        return new org.jvnet.olt.filters.xliffsubsegment.xliff.impl.PhaseGroupImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Phase == null)? 0 :_Phase.size());
        context.startElement("", "phase-group");
        int idx_0 = idx1;
        while (idx_0 != len1) {
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Phase.get(idx_0 ++)), "Phase");
        }
        context.endNamespaceDecls();
        int idx_1 = idx1;
        while (idx_1 != len1) {
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Phase.get(idx_1 ++)), "Phase");
        }
        context.endAttributes();
        while (idx1 != len1) {
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Phase.get(idx1 ++)), "Phase");
        }
        context.endElement();
    }
...
+"t\u0000.org.jvnet.olt.filters.xliffsubsegment.xliff.Phaset\u0000+http://j"
+"ava.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u001bt\u0000\u000bphase-groupt\u0000\u0000sr"
...
+"l;xp\u0000\u0000\u0000\u0003\u0001pq\u0000~\u0000\rq\u0000~\u0000\tq\u0000~\u0000\u000ex"));
        ...
        extends org.jvnet.olt.filters.xliffsubsegment.xliff.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return org.jvnet.olt.filters.xliffsubsegment.xliff.impl.PhaseGroupImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("phase" == ___local)&&("" == ___uri)) {
                            _getPhase().add(((org.jvnet.olt.filters.xliffsubsegment.xliff.impl.PhaseImpl) spawnChildFromEnterElement((org.jvnet.olt.filters.xliffsubsegment.xliff.impl.PhaseImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  2 :
