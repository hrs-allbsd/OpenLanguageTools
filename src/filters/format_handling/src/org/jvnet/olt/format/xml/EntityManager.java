...
/**
 * This class is a manager class that stores XmlEntity object for
...
public class EntityManager
    ...
    private XmlEntity resolveEntity(String variable, String type) throws GlobalVariableManagerException {
        XmlEntity entity = null;
        ...
        switch (variableType) {
            case PARAMETER:
                entity = (XmlEntity) parameterEntityMap.get(flag);
                break;
            case INTERNAL:
                entity = (XmlEntity) internalEntityMap.get(flag);
                break;
            case SYSTEM:
                entity = (XmlEntity) systemEntityMap.get(flag);
                break;
            case CHARACTER:
                entity = (XmlEntity) characterEntityMap.get(flag);
                break;
        }
        if (entity == null) {
            return null;
    ...
    public void setVariable(String name, String value, String type) throws GlobalVariableManagerException {
        ...
        XmlEntity entity = new XmlEntity(name, value, type);
        switch (i.intValue()) {
            case PARAMETER:
    ...
    public String toString() {
        ...
        while (it.hasNext()) {
            ...
            XmlEntity ent = (XmlEntity) parameterEntityMap.get(key);
        ...
        while (it.hasNext()) {
            String key = (String) it.next();
            XmlEntity ent = (XmlEntity) systemEntityMap.get(key);
            String value = ent.getValue();
            String type = ent.getType();
            buf.append(key + " = " + value + " (" + type + ")\n");
        }
        ...
        while (it.hasNext()) {
            String key = (String) it.next();
            XmlEntity ent = (XmlEntity) internalEntityMap.get(key);
            String value = ent.getValue();
            String type = ent.getType();
            buf.append(key + " = " + value + " (" + type + ")\n");
        }
        ...
        while (it.hasNext()) {
            String key = (String) it.next();
            XmlEntity ent = (XmlEntity) characterEntityMap.get(key);
            String value = ent.getValue();
            String type = ent.getType();
            buf.append(key + " = " + value + " (" + type + ")\n");
        }
