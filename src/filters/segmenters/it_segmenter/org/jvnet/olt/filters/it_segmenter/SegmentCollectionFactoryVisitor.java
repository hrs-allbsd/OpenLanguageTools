...
public class SegmentCollectionFactoryVisitor implements Segmenter_itVisitor
{
	...
	case Segmenter_itTreeConstants.JJTFORMATTING:
	    ...
	    break;
	    //case Segmenter_itTreeConstants.JJTSENTSEP:
	    //break;
	    //	case Segmenter_itTreeConstants.JJTFORMATTING:
	    //System.out.println ("Formatting! : "+node.getNodeData());
	    //break;
	case Segmenter_itTreeConstants.JJTSEGMENT:
