...
public class SegmentCollectionFactoryVisitor implements Segmenter_svVisitor
{
	...
	case Segmenter_svTreeConstants.JJTFORMATTING:
	    ...
	    break;
	    //case Segmenter_svTreeConstants.JJTSENTSEP:
	    //break;
	    //	case Segmenter_svTreeConstants.JJTFORMATTING:
	    //System.out.println ("Formatting! : "+node.getNodeData());
	    //break;
	case Segmenter_svTreeConstants.JJTSEGMENT:
