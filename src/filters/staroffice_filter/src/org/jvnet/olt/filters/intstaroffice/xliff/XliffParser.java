 ...
 * translates all related events into XliffHandler events.
 * <p>Usage sample:
 * <pre>
...
public class XliffParser implements ContentHandler {
     ...
     */
    public XliffParser(final XliffHandler handler, final EntityResolver resolver) {
    ...
    private void dispatch(final boolean fireOnlyIfMixed) throws SAXException {
        ...
        if ("mrk".equals(here)) {
            ...
            if (fireOnlyIfMixed) throw new SAXException("Unexpected characters() event! (Missing DTD?)");
     ...
     * @throws javax.xml.parsers.FactoryConfigurationRrror if the implementation can not be instantiated.
     */
    public static void parse(final InputSource input, final XliffHandler handler) throws SAXException, javax.xml.parsers.ParserConfigurationException, java.io.IOException {
     ...
     * @throws javax.xml.parsers.FactoryConfigurationRrror if the implementation can not be instantiated.
     */
    public static void parse(final java.net.URL url, final XliffHandler handler) throws SAXException, javax.xml.parsers.ParserConfigurationException, java.io.IOException {
        parse(new InputSource(url.toExternalForm()), handler);
    }
    
    private static void parse(final InputSource input, final XliffParser recognizer) throws SAXException, javax.xml.parsers.ParserConfigurationException, java.io.IOException {
        javax.xml.parsers.SAXParserFactory factory = javax.xml.parsers.SAXParserFactory.newInstance();
        factory.setValidating(false);  // don't want this to validate!
