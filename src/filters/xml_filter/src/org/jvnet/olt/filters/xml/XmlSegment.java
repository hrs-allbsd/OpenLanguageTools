...
/**
 * This is a useful test program thrown together to test the output
 * of the XML filter. Not used by the production systems, but handy
 * to have.
 * @author  timf
 */
public class XmlSegment {
     ...
     * from the user
     */
    public XmlSegment(String directory, String filename, String language, String encoding, Logger logger, String dummyDTDFile) throws XmlParseException, IOException{
        this.guid = null;
     ...
     */
    public XmlSegment(String directory, String filename, String language, String encoding, Logger logger, String dummyDTDFile, XmlIdentifier id) throws XmlParseException, IOException {
        this.guid = null;
        this.dummyDTDFile = dummyDTDFile;
    ...
    Logger logger, XmlIdentifier id ) throws XmlParseException, IOException{
       ...
       // System.out.println("xmlIdentifier is " + xmlIdentifier);
        ...
        parser.parseXmlForDemo(language, xmlTagTable, xmlSegmenterTable);
     ...
     */
    public XmlSegment(String directory, String filename, String language, String encoding, Logger logger, String guid, String dummyDTDFile) throws XmlParseException, IOException{
        this.guid = guid;
        this.dummyDTDFile = dummyDTDFile;
        this.convert(directory,filename,language,encoding,logger,null);
    ...
    public static String getDummyDTDFile() throws NamingException {
        ...
        if(dummyDTDFile.equals("")) {
            ...
            XmlSegment.dummyDTDFile = (String)
    ...
    public static void main(String[] argv) {
        try {
            ...
            if (argv.length != 5){
                System.out.println("Usage : XmlSegment <xml-config-dtd> <xml-config-store> <input file> <language> <dummy-dtd-location>\n"+
            ...
            XmlSegment task = new XmlSegment("", argv[2], argv[3], System.getProperty("file.encoding"), logger, argv[4]);
        } catch (Exception e){
