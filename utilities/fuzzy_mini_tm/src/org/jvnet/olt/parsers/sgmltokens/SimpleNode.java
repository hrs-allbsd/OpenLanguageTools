...
implements Node, SimpleSGMLTokenizerTreeConstants
{
  ...
  protected boolean tagHasAttributes = false;
  ...
  /** Accept the visitor. **/
  public Object jjtAccept(SimpleSGMLTokenizerVisitor visitor, Object data)  {
...
/** Accept the visitor. **/
  ...
  public Object childrenAccept(SimpleSGMLTokenizerVisitor visitor, Object data) {
    if (children != null) {
  ...
  public String toString() { return SimpleSGMLTokenizerTreeConstants.jjtNodeName[id]; }
  ...
  public void setTagWithAttribs(boolean hasAttribs)
  {
    tagHasAttributes = hasAttribs;
  }

  public boolean hasAttribs()
  {
    return tagHasAttributes;
  }
