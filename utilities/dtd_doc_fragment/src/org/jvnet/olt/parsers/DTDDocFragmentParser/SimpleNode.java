...
implements Node, TaggedMarkupNode
{
  ...
  /** Accept the visitor. **/
  public Object jjtAccept(DTDDocFragmentParserVisitor visitor, Object data)  {
...
/** Accept the visitor. **/
  ...
  public Object childrenAccept(DTDDocFragmentParserVisitor visitor, Object data) {
    if (children != null) {
  ...
  public String toString() { return DTDDocFragmentParserTreeConstants.jjtNodeName[id]; }
